 ...
 * same construction as `execution-ssh/src/confirmation/hash-registry.ts` (see operation-hash.ts
 * in this package for why it is duplicated rather than shared). Three states, never surviving a
 * process restart:
